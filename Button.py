...
class ButtonManager:
    ...
    def button_setting(self):
        ...
        # You can test the example using that function.
        # You can specify the number of buttons or text.
        btn = Button()
        btn.set_text("Button1")
        btn2 = Button()
        btn2.set_text("Button2")
        btn3 = Button()
        btn3.set_text("Button3")
        btn_list = [btn, btn2, btn3]
